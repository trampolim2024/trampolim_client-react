                    ...
                    <div className='flex items-center justify-center gap-10 w-[75vw] border-b-2 border-orange-300 pb-10'>
                        ...
                        <label htmlFor="data-nascimento">
                            ...
                            <div className='relative'>
                                ...
                                <input type="password" id="senha" name="senha" className='w-full pl-8 p-3 rounded-xl outline-none border-2 border-orange-400 shadow-md bg-transparent' value={formData.senha} onChange={handleChange} />
                            </div>
                        </label>
